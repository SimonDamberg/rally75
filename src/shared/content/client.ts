...
export const HOME = {
  ...
  noRaceText: 'Spelledaren sadlar nästa lopp. Håll telefonen nära.',
  ...
  closedText: 'Hästarna går till start. Nu kan bara hästarna ändra något.',
  yourBets: 'Dina spel på loppet',
  noBetsHere: 'Du har inga spel på det här loppet.',
...
export const REVEAL = {
  ...
  refundText: 'Dina insatser är tillbaka på kontot.',
...
export const BOARD = {
  ...
  empty: 'Inga spelare än. Bli först.',
  you: 'Du',
