...
export const ERROR_MESSAGES = {
  ...
  box_empty: 'Lådan är tom. Allt är redan vunnet.',
  not_a_box: 'Det där är ingen låda.',
  use_open_box: 'Lådan måste öppnas, inte köpas. Ladda om sidan.',
  ...
  prize_not_found: 'Vinsten finns inte längre i lådan.',
  bad_rarity: 'Okänd sällsynthet.',
