// The stable's own kuskar: Simon's friends. Seed data for the `kusks` table (Stage 2);
// at runtime the GM edits them in the DB. Keep the shape: one running joke, seven notes each.
