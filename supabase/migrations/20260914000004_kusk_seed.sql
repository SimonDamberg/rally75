-- Seed: the stable's own kuskar, copied from NAMED_KUSKAR (src/shared/content/kuskar.ts).
-- src/shared/content/kuskSeed.test.ts checks that this file stays in sync.
