...
--
-- Replaces the eight originals from 20260914000004_kusk_seed.sql, whose notes were rewritten, and
-- adds the new kuskar. Deleting by name rather than truncating leaves any kusk Simon added by
